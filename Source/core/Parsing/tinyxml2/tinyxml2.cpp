...
bool XMLUtil::ToBool( const char* str, bool* value )
{
    ...
    static const char* TRUE_0[] = { "true", "True", "TRUE", 0 };
    static const char* FALSE_0[] = { "false", "False", "FALSE", 0 };

    for (int i = 0; TRUE_0[i]; ++i) {
        if (StringEqual(str, TRUE_0[i])) {
            *value = true;
            return true;
        }
    }
    for (int i = 0; FALSE_0[i]; ++i) {
        if (StringEqual(str, FALSE_0[i])) {
            *value = false;
            return true;
        }
    }
