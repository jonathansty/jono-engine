...
String::String(wchar_t const* wideTextPtr)
{
	...
	if constexpr (sizeof(TCHAR) == 2) _tcscpy_s(m_TextPtr, m_Length, (TCHAR*)wideTextPtr);
...
String::String(char const* singleTextPtr)
{
	...
	if constexpr (sizeof(TCHAR) == 1) strcpy_s((char*)m_TextPtr, m_Length, singleTextPtr);
